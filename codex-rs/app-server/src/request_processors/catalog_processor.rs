...
fn plugin_provenance(marketplace_name: &str) -> codex_app_server_protocol::SkillProvenance {
    match marketplace_name {
        ...
        | codex_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_MARKETPLACE_NAME
        | codex_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_PRIVATE_MARKETPLACE_NAME
        | codex_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_UNLISTED_MARKETPLACE_NAME => {
                ...
                async move {
                    ...
                    let (effective_skill_roots, plugins_by_id) = if workspace_codex_plugins_enabled
                    {
                        ...
                        let plugin_outcome = plugins_manager
                            .plugins_for_layer_stack(&config_layer_stack, &plugins_input)
                            .await;
                        (
